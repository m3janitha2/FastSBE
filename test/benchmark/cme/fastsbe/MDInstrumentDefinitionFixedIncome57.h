...
class MDInstrumentDefinitionFixedIncome57
{
    ...
    class NoEvents
    {
    	friend MDInstrumentDefinitionFixedIncome57;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFixedIncome57::NoEvents &group)
{
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFixedIncome57::NoMDFeedTypes &group)
{
	for (auto i = 0; i < group.num_in_group(); i++)
	{
		auto &g = group.get(i);
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFixedIncome57::NoInstAttrib &group)
{
	for (auto i = 0; i < group.num_in_group(); i++)
	{
		auto &g = group.get(i);
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFixedIncome57::NoLotTypeRules &group)
{
	for (auto i = 0; i < group.num_in_group(); i++)
	{
		auto &g = group.get(i);
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFixedIncome57 &msg)
{
	...
	os << msg.issue_date_name() << ": " << msg.issue_date() << " ";
	os << msg.dated_date_name() << ": " << msg.dated_date() << " ";
	os << msg.maturity_date_name() << ": " << msg.maturity_date() << " ";
	os << msg.coupon_rate_name() << ": " << msg.coupon_rate() << " ";
	os << msg.par_value_name() << ": " << msg.par_value() << " ";
	os << msg.coupon_frequency_unit_name() << ": " << msg.coupon_frequency_unit() << " ";
	os << msg.coupon_frequency_period_name() << ": " << msg.coupon_frequency_period() << " ";
	os << msg.coupon_day_count_name() << ": " << msg.coupon_day_count() << " ";
	os << msg.country_of_issue_name() << ": " << msg.country_of_issue() << " ";
	os << msg.issuer_name() << ": " << msg.issuer() << " ";
	os << msg.financial_instrument_full_name_name() << ": " << msg.financial_instrument_full_name() << " ";
	os << msg.security_alt_id_name() << ": " << msg.security_alt_id() << " ";
	os << msg.security_alt_id_source_name() << ": " << msg.security_alt_id_source() << " ";
