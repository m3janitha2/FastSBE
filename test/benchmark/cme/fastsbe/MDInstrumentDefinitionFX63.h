...
class MDInstrumentDefinitionFX63
{
    ...
    public:
    	...
    	{ 
    		return "MDInstrumentDefinitionFX63"; 
    	}
    ...
    private:
    	char price_quote_currency_[3]{};
    
    public:
    	static constexpr std::size_t price_quote_currency_size() noexcept
    	{
    		return 3;
    	}
    
    	static constexpr std::size_t price_quote_currency_offset() noexcept
    	{
    		return 77;
    	}
    
    	static constexpr std::size_t price_quote_currency_id() noexcept
    	{
    		return 1524;
    	}
    
    	static constexpr const char *price_quote_currency_name() noexcept
    	{
    		return "PriceQuoteCurrency";
    	}
    
    	constexpr char *price_quote_currency() noexcept
    	{
    		return price_quote_currency_;
    	}
    
    	constexpr const char *price_quote_currency() const noexcept
    	{
    		return price_quote_currency_;
    	}
    
    	constexpr std::string_view price_quote_currency_view() noexcept
    	{
    		return std::string_view(price_quote_currency_, 3);
    	}
    
    	constexpr const std::string_view price_quote_currency_view() const noexcept
    	{
    		return std::string_view(price_quote_currency_, 3);
    	}
    
    	constexpr const std::string price_quote_currency_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 3 && *(price_quote_currency_ + length) != '\0'; ++length);
    		return std::string(price_quote_currency_, length);
    	}
    
    	constexpr auto &set_price_quote_currency(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(price_quote_currency_, value, price_quote_currency_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_price_quote_currency(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < price_quote_currency_size() ? size : price_quote_currency_size();
    		std::memcpy(price_quote_currency_, value, length);
    		std::memset(price_quote_currency_ + length, 0, price_quote_currency_size() - length);
    		return *this;
    	}
    
    	auto &set_price_quote_currency(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(price_quote_currency_size(), value.size());
    		std::memcpy(price_quote_currency_, value.data(), price_quote_currency_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    public:
    	static constexpr std::size_t price_precision_size() noexcept
    	{
    		return sizeof(std::uint8_t);
    	}
    
    	static constexpr std::size_t price_precision_offset() noexcept
    	{ 
    		return 105; 
    	}
    
    	static constexpr std::size_t price_precision_id() noexcept
    	{ 
    		return 2349; 
    	}
    	
    	static constexpr const char* price_precision_name() noexcept
    	{ 
    		return "PricePrecision"; 
    	}
    	
    	static constexpr std::uint8_t price_precision_min_value() noexcept
    	{ 
    		return 0; 
    	}
    	
    	static constexpr std::uint8_t price_precision_max_value() noexcept
    	{
    		return (UINT8_MAX - 1);
    	}
    	
    	static constexpr std::uint8_t price_precision_null_value() noexcept
    	{
    		return UINT8_MAX;
    	}
    
    	constexpr std::uint8_t price_precision() const noexcept
    	{ 
    		return price_precision_;
    	}
    	
    	constexpr auto& set_price_precision(std::uint8_t value) noexcept
    	{
    		price_precision_ = value;
    		return *this;
    	}
    ...
    public:
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_financial_instrument_full_name(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < financial_instrument_full_name_size() ? size : financial_instrument_full_name_size();
    		std::memcpy(financial_instrument_full_name_, value, length);
    		std::memset(financial_instrument_full_name_ + length, 0, financial_instrument_full_name_size() - length);
    		return *this;
    	}
    ...
    private:
    	char fx_currency_symbol_[7]{};
    
    public:
    	static constexpr std::size_t fx_currency_symbol_size() noexcept
    	{
    		return 7;
    	}
    
    	static constexpr std::size_t fx_currency_symbol_offset() noexcept
    	{
    		return 204;
    	}
    
    	static constexpr std::size_t fx_currency_symbol_id() noexcept
    	{
    		return 37725;
    	}
    
    	static constexpr const char *fx_currency_symbol_name() noexcept
    	{
    		return "FXCurrencySymbol";
    	}
    
    	constexpr char *fx_currency_symbol() noexcept
    	{
    		return fx_currency_symbol_;
    	}
    
    	constexpr const char *fx_currency_symbol() const noexcept
    	{
    		return fx_currency_symbol_;
    	}
    
    	constexpr std::string_view fx_currency_symbol_view() noexcept
    	{
    		return std::string_view(fx_currency_symbol_, 7);
    	}
    
    	constexpr const std::string_view fx_currency_symbol_view() const noexcept
    	{
    		return std::string_view(fx_currency_symbol_, 7);
    	}
    
    	constexpr const std::string fx_currency_symbol_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 7 && *(fx_currency_symbol_ + length) != '\0'; ++length);
    		return std::string(fx_currency_symbol_, length);
    	}
    
    	constexpr auto &set_fx_currency_symbol(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(fx_currency_symbol_, value, fx_currency_symbol_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_fx_currency_symbol(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < fx_currency_symbol_size() ? size : fx_currency_symbol_size();
    		std::memcpy(fx_currency_symbol_, value, length);
    		std::memset(fx_currency_symbol_ + length, 0, fx_currency_symbol_size() - length);
    		return *this;
    	}
    
    	auto &set_fx_currency_symbol(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(fx_currency_symbol_size(), value.size());
    		std::memcpy(fx_currency_symbol_, value.data(), fx_currency_symbol_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    public:
    	static constexpr std::size_t settl_type_size() noexcept
    	{
    		return 3;
    	}
    
    	static constexpr std::size_t settl_type_offset() noexcept
    	{
    		return 211;
    	}
    
    	static constexpr std::size_t settl_type_id() noexcept
    	{
    		return 63;
    	}
    
    	static constexpr const char *settl_type_name() noexcept
    	{
    		return "SettlType";
    	}
    
    	constexpr char *settl_type() noexcept
    	{
    		return settl_type_;
    	}
    
    	constexpr const char *settl_type() const noexcept
    	{
    		return settl_type_;
    	}
    
    	constexpr std::string_view settl_type_view() noexcept
    	{
    		return std::string_view(settl_type_, 3);
    	}
    
    	constexpr const std::string_view settl_type_view() const noexcept
    	{
    		return std::string_view(settl_type_, 3);
    	}
    
    	constexpr const std::string settl_type_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 3 && *(settl_type_ + length) != '\0'; ++length);
    		return std::string(settl_type_, length);
    	}
    
    	constexpr auto &set_settl_type(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(settl_type_, value, settl_type_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_settl_type(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < settl_type_size() ? size : settl_type_size();
    		std::memcpy(settl_type_, value, length);
    		std::memset(settl_type_ + length, 0, settl_type_size() - length);
    		return *this;
    	}
    
    	auto &set_settl_type(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(settl_type_size(), value.size());
    		std::memcpy(settl_type_, value.data(), settl_type_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	std::uint16_t intervening_days_{};
    
    public:
    	static constexpr std::size_t intervening_days_size() noexcept
    	{
    		return sizeof(std::uint16_t);
    	}
    
    	static constexpr std::size_t intervening_days_offset() noexcept
    	{ 
    		return 214; 
    	}
    
    	static constexpr std::size_t intervening_days_id() noexcept
    	{ 
    		return 37730; 
    	}
    	
    	static constexpr const char* intervening_days_name() noexcept
    	{ 
    		return "InterveningDays"; 
    	}
    	
    	static constexpr std::uint16_t intervening_days_min_value() noexcept
    	{ 
    		return 0; 
    	}
    	
    	static constexpr std::uint16_t intervening_days_max_value() noexcept
    	{
    		return (UINT16_MAX - 1);
    	}
    	
    	static constexpr std::uint16_t intervening_days_null_value() noexcept
    	{
    		return UINT16_MAX;
    	}
    
    	constexpr std::uint16_t intervening_days() const noexcept
    	{ 
    		return intervening_days_;
    	}
    	
    	constexpr auto& set_intervening_days(std::uint16_t value) noexcept
    	{
    		intervening_days_ = value;
    		return *this;
    	}
    
    
    private:
    	char fx_benchmark_rate_fix_[20]{};
    
    public:
    	static constexpr std::size_t fx_benchmark_rate_fix_size() noexcept
    	{
    		return 20;
    	}
    
    	static constexpr std::size_t fx_benchmark_rate_fix_offset() noexcept
    	{
    		return 216;
    	}
    
    	static constexpr std::size_t fx_benchmark_rate_fix_id() noexcept
    	{
    		return 2796;
    	}
    
    	static constexpr const char *fx_benchmark_rate_fix_name() noexcept
    	{
    		return "FXBenchmarkRateFix";
    	}
    
    	constexpr char *fx_benchmark_rate_fix() noexcept
    	{
    		return fx_benchmark_rate_fix_;
    	}
    
    	constexpr const char *fx_benchmark_rate_fix() const noexcept
    	{
    		return fx_benchmark_rate_fix_;
    	}
    
    	constexpr std::string_view fx_benchmark_rate_fix_view() noexcept
    	{
    		return std::string_view(fx_benchmark_rate_fix_, 20);
    	}
    
    	constexpr const std::string_view fx_benchmark_rate_fix_view() const noexcept
    	{
    		return std::string_view(fx_benchmark_rate_fix_, 20);
    	}
    
    	constexpr const std::string fx_benchmark_rate_fix_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 20 && *(fx_benchmark_rate_fix_ + length) != '\0'; ++length);
    		return std::string(fx_benchmark_rate_fix_, length);
    	}
    
    	constexpr auto &set_fx_benchmark_rate_fix(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(fx_benchmark_rate_fix_, value, fx_benchmark_rate_fix_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_fx_benchmark_rate_fix(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < fx_benchmark_rate_fix_size() ? size : fx_benchmark_rate_fix_size();
    		std::memcpy(fx_benchmark_rate_fix_, value, length);
    		std::memset(fx_benchmark_rate_fix_ + length, 0, fx_benchmark_rate_fix_size() - length);
    		return *this;
    	}
    
    	auto &set_fx_benchmark_rate_fix(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(fx_benchmark_rate_fix_size(), value.size());
    		std::memcpy(fx_benchmark_rate_fix_, value.data(), fx_benchmark_rate_fix_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	char rate_source_[12]{};
    
    public:
    	static constexpr std::size_t rate_source_size() noexcept
    	{
    		return 12;
    	}
    
    	static constexpr std::size_t rate_source_offset() noexcept
    	{
    		return 236;
    	}
    
    	static constexpr std::size_t rate_source_id() noexcept
    	{
    		return 1446;
    	}
    
    	static constexpr const char *rate_source_name() noexcept
    	{
    		return "RateSource";
    	}
    
    	constexpr char *rate_source() noexcept
    	{
    		return rate_source_;
    	}
    
    	constexpr const char *rate_source() const noexcept
    	{
    		return rate_source_;
    	}
    
    	constexpr std::string_view rate_source_view() noexcept
    	{
    		return std::string_view(rate_source_, 12);
    	}
    
    	constexpr const std::string_view rate_source_view() const noexcept
    	{
    		return std::string_view(rate_source_, 12);
    	}
    
    	constexpr const std::string rate_source_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 12 && *(rate_source_ + length) != '\0'; ++length);
    		return std::string(rate_source_, length);
    	}
    
    	constexpr auto &set_rate_source(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(rate_source_, value, rate_source_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_rate_source(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < rate_source_size() ? size : rate_source_size();
    		std::memcpy(rate_source_, value, length);
    		std::memset(rate_source_ + length, 0, rate_source_size() - length);
    		return *this;
    	}
    
    	auto &set_rate_source(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(rate_source_size(), value.size());
    		std::memcpy(rate_source_, value.data(), rate_source_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	char fix_rate_local_time_[8]{};
    
    public:
    	static constexpr std::size_t fix_rate_local_time_size() noexcept
    	{
    		return 8;
    	}
    
    	static constexpr std::size_t fix_rate_local_time_offset() noexcept
    	{
    		return 248;
    	}
    
    	static constexpr std::size_t fix_rate_local_time_id() noexcept
    	{
    		return 37726;
    	}
    
    	static constexpr const char *fix_rate_local_time_name() noexcept
    	{
    		return "FixRateLocalTime";
    	}
    
    	constexpr char *fix_rate_local_time() noexcept
    	{
    		return fix_rate_local_time_;
    	}
    
    	constexpr const char *fix_rate_local_time() const noexcept
    	{
    		return fix_rate_local_time_;
    	}
    
    	constexpr std::string_view fix_rate_local_time_view() noexcept
    	{
    		return std::string_view(fix_rate_local_time_, 8);
    	}
    
    	constexpr const std::string_view fix_rate_local_time_view() const noexcept
    	{
    		return std::string_view(fix_rate_local_time_, 8);
    	}
    
    	constexpr const std::string fix_rate_local_time_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 8 && *(fix_rate_local_time_ + length) != '\0'; ++length);
    		return std::string(fix_rate_local_time_, length);
    	}
    
    	constexpr auto &set_fix_rate_local_time(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(fix_rate_local_time_, value, fix_rate_local_time_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_fix_rate_local_time(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < fix_rate_local_time_size() ? size : fix_rate_local_time_size();
    		std::memcpy(fix_rate_local_time_, value, length);
    		std::memset(fix_rate_local_time_ + length, 0, fix_rate_local_time_size() - length);
    		return *this;
    	}
    
    	auto &set_fix_rate_local_time(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(fix_rate_local_time_size(), value.size());
    		std::memcpy(fix_rate_local_time_, value.data(), fix_rate_local_time_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	char fix_rate_local_time_zone_[20]{};
    
    public:
    	static constexpr std::size_t fix_rate_local_time_zone_size() noexcept
    	{
    		return 20;
    	}
    
    	static constexpr std::size_t fix_rate_local_time_zone_offset() noexcept
    	{
    		return 256;
    	}
    
    	static constexpr std::size_t fix_rate_local_time_zone_id() noexcept
    	{
    		return 37727;
    	}
    
    	static constexpr const char *fix_rate_local_time_zone_name() noexcept
    	{
    		return "FixRateLocalTimeZone";
    	}
    
    	constexpr char *fix_rate_local_time_zone() noexcept
    	{
    		return fix_rate_local_time_zone_;
    	}
    
    	constexpr const char *fix_rate_local_time_zone() const noexcept
    	{
    		return fix_rate_local_time_zone_;
    	}
    
    	constexpr std::string_view fix_rate_local_time_zone_view() noexcept
    	{
    		return std::string_view(fix_rate_local_time_zone_, 20);
    	}
    
    	constexpr const std::string_view fix_rate_local_time_zone_view() const noexcept
    	{
    		return std::string_view(fix_rate_local_time_zone_, 20);
    	}
    
    	constexpr const std::string fix_rate_local_time_zone_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 20 && *(fix_rate_local_time_zone_ + length) != '\0'; ++length);
    		return std::string(fix_rate_local_time_zone_, length);
    	}
    
    	constexpr auto &set_fix_rate_local_time_zone(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(fix_rate_local_time_zone_, value, fix_rate_local_time_zone_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_fix_rate_local_time_zone(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < fix_rate_local_time_zone_size() ? size : fix_rate_local_time_zone_size();
    		std::memcpy(fix_rate_local_time_zone_, value, length);
    		std::memset(fix_rate_local_time_zone_ + length, 0, fix_rate_local_time_zone_size() - length);
    		return *this;
    	}
    
    	auto &set_fix_rate_local_time_zone(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(fix_rate_local_time_zone_size(), value.size());
    		std::memcpy(fix_rate_local_time_zone_, value.data(), fix_rate_local_time_zone_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	std::uint32_t min_quote_life_{};
    
    public:
    	static constexpr std::size_t min_quote_life_size() noexcept
    	{
    		return sizeof(std::uint32_t);
    	}
    
    	static constexpr std::size_t min_quote_life_offset() noexcept
    	{ 
    		return 276; 
    	}
    
    	static constexpr std::size_t min_quote_life_id() noexcept
    	{ 
    		return 37731; 
    	}
    	
    	static constexpr const char* min_quote_life_name() noexcept
    	{ 
    		return "MinQuoteLife"; 
    	}
    	
    	static constexpr std::uint32_t min_quote_life_min_value() noexcept
    	{ 
    		return 0; 
    	}
    	
    	static constexpr std::uint32_t min_quote_life_max_value() noexcept
    	{
    		return (UINT32_MAX - 1);
    	}
    	
    	static constexpr std::uint32_t min_quote_life_null_value() noexcept
    	{
    		return UINT32_MAX;
    	}
    
    	constexpr std::uint32_t min_quote_life() const noexcept
    	{ 
    		return min_quote_life_;
    	}
    	
    	constexpr auto& set_min_quote_life(std::uint32_t value) noexcept
    	{
    		min_quote_life_ = value;
    		return *this;
    	}
    
    
    private:
    	Price9 max_price_discretion_offset_{};
    
    public:
    	static constexpr std::size_t max_price_discretion_offset_size() noexcept
    	{
    		return sizeof(Price9);
    	}
    
    	static constexpr std::size_t max_price_discretion_offset_offset() noexcept
    	{
    		return 280;
    	}
    
    	static constexpr std::size_t max_price_discretion_offset_id() noexcept
    	{
    		return 37728;
    	}
    
    	static constexpr const char *max_price_discretion_offset_name() noexcept
    	{
    		return "MaxPriceDiscretionOffset";
    	}
    
    	constexpr const Price9 &max_price_discretion_offset() const noexcept
    	{
    		return max_price_discretion_offset_;
    	}
    
    	constexpr Price9 &max_price_discretion_offset() noexcept
    	{
    		return max_price_discretion_offset_;
    	}
    	constexpr auto &set_max_price_discretion_offset(Price9 &value) noexcept
    	{
    		max_price_discretion_offset_ = value;
    		return *this;
    	}
    ...
    private:
    	char settlement_locale_[8]{};
    
    public:
    	static constexpr std::size_t settlement_locale_size() noexcept
    	{
    		return 8;
    	}
    
    	static constexpr std::size_t settlement_locale_offset() noexcept
    	{
    		return 301;
    	}
    
    	static constexpr std::size_t settlement_locale_id() noexcept
    	{
    		return 37734;
    	}
    
    	static constexpr const char *settlement_locale_name() noexcept
    	{
    		return "SettlementLocale";
    	}
    
    	constexpr char *settlement_locale() noexcept
    	{
    		return settlement_locale_;
    	}
    
    	constexpr const char *settlement_locale() const noexcept
    	{
    		return settlement_locale_;
    	}
    
    	constexpr std::string_view settlement_locale_view() noexcept
    	{
    		return std::string_view(settlement_locale_, 8);
    	}
    
    	constexpr const std::string_view settlement_locale_view() const noexcept
    	{
    		return std::string_view(settlement_locale_, 8);
    	}
    
    	constexpr const std::string settlement_locale_string() const noexcept
    	{
    		auto length = 0ULL;
    		for (; length < 8 && *(settlement_locale_ + length) != '\0'; ++length);
    		return std::string(settlement_locale_, length);
    	}
    
    	constexpr auto &set_settlement_locale(const char *value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		std::memcpy(settlement_locale_, value, settlement_locale_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    	...
    	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
    	auto &set_settlement_locale(const char *value, std::size_t size) noexcept
    	{
    		const auto length = size < settlement_locale_size() ? size : settlement_locale_size();
    		std::memcpy(settlement_locale_, value, length);
    		std::memset(settlement_locale_ + length, 0, settlement_locale_size() - length);
    		return *this;
    	}
    
    	auto &set_settlement_locale(std::string_view value) noexcept
    	{
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic push
    	#pragma GCC diagnostic ignored "-Wstringop-overflow"
    	#pragma GCC diagnostic ignored "-Wstringop-overread"
    	#endif
    		// auto size = std::min(settlement_locale_size(), value.size());
    		std::memcpy(settlement_locale_, value.data(), settlement_locale_size());
    		return *this;
    	#if defined(__GNUG__)
    	#pragma GCC diagnostic pop
    	#endif
    ...
    private:
    	Pricenull9 alt_min_price_increment_{};
    
    public:
    	static constexpr std::size_t alt_min_price_increment_size() noexcept
    	{
    		return sizeof(Pricenull9);
    	}
    
    	static constexpr std::size_t alt_min_price_increment_offset() noexcept
    	{
    		return 309;
    	}
    
    	static constexpr std::size_t alt_min_price_increment_id() noexcept
    	{
    		return 37739;
    	}
    
    	static constexpr const char *alt_min_price_increment_name() noexcept
    	{
    		return "AltMinPriceIncrement";
    	}
    
    	constexpr const Pricenull9 &alt_min_price_increment() const noexcept
    	{
    		return alt_min_price_increment_;
    	}
    
    	constexpr Pricenull9 &alt_min_price_increment() noexcept
    	{
    		return alt_min_price_increment_;
    	}
    	constexpr auto &set_alt_min_price_increment(Pricenull9 &value) noexcept
    	{
    		alt_min_price_increment_ = value;
    		return *this;
    	}
    
    
    private:
    	std::uint32_t alt_min_quote_life_{};
    
    public:
    	static constexpr std::size_t alt_min_quote_life_size() noexcept
    	{
    		return sizeof(std::uint32_t);
    	}
    
    	static constexpr std::size_t alt_min_quote_life_offset() noexcept
    	{ 
    		return 317; 
    	}
    
    	static constexpr std::size_t alt_min_quote_life_id() noexcept
    	{ 
    		return 37738; 
    	}
    	
    	static constexpr const char* alt_min_quote_life_name() noexcept
    	{ 
    		return "AltMinQuoteLife"; 
    	}
    	
    	static constexpr std::uint32_t alt_min_quote_life_min_value() noexcept
    	{ 
    		return 0; 
    	}
    	
    	static constexpr std::uint32_t alt_min_quote_life_max_value() noexcept
    	{
    		return (UINT32_MAX - 1);
    	}
    	
    	static constexpr std::uint32_t alt_min_quote_life_null_value() noexcept
    	{
    		return UINT32_MAX;
    	}
    
    	constexpr std::uint32_t alt_min_quote_life() const noexcept
    	{ 
    		return alt_min_quote_life_;
    	}
    	
    	constexpr auto& set_alt_min_quote_life(std::uint32_t value) noexcept
    	{
    		alt_min_quote_life_ = value;
    		return *this;
    	}
    
    
    private:
    	Pricenull9 alt_price_increment_constraint_{};
    
    public:
    	static constexpr std::size_t alt_price_increment_constraint_size() noexcept
    	{
    		return sizeof(Pricenull9);
    	}
    
    	static constexpr std::size_t alt_price_increment_constraint_offset() noexcept
    	{
    		return 321;
    	}
    
    	static constexpr std::size_t alt_price_increment_constraint_id() noexcept
    	{
    		return 37742;
    	}
    
    	static constexpr const char *alt_price_increment_constraint_name() noexcept
    	{
    		return "AltPriceIncrementConstraint";
    	}
    
    	constexpr const Pricenull9 &alt_price_increment_constraint() const noexcept
    	{
    		return alt_price_increment_constraint_;
    	}
    
    	constexpr Pricenull9 &alt_price_increment_constraint() noexcept
    	{
    		return alt_price_increment_constraint_;
    	}
    	constexpr auto &set_alt_price_increment_constraint(Pricenull9 &value) noexcept
    	{
    		alt_price_increment_constraint_ = value;
    		return *this;
    	}
    
    
    private:
    	Pricenull9 max_bid_ask_constraint_{};
    
    public:
    	static constexpr std::size_t max_bid_ask_constraint_size() noexcept
    	{
    		return sizeof(Pricenull9);
    	}
    
    	static constexpr std::size_t max_bid_ask_constraint_offset() noexcept
    	{
    		return 329;
    	}
    
    	static constexpr std::size_t max_bid_ask_constraint_id() noexcept
    	{
    		return 37743;
    	}
    
    	static constexpr const char *max_bid_ask_constraint_name() noexcept
    	{
    		return "MaxBidAskConstraint";
    	}
    
    	constexpr const Pricenull9 &max_bid_ask_constraint() const noexcept
    	{
    		return max_bid_ask_constraint_;
    	}
    
    	constexpr Pricenull9 &max_bid_ask_constraint() noexcept
    	{
    		return max_bid_ask_constraint_;
    	}
    	constexpr auto &set_max_bid_ask_constraint(Pricenull9 &value) noexcept
    	{
    		max_bid_ask_constraint_ = value;
    		return *this;
    	}
    ...
    class NoEvents
    {
    	template <std::size_t> friend class MDInstrumentDefinitionFX63;
    ...
    class NoLotTypeRules
    {
        ...
        class Entry
        {
            ...
            public:
            	...
            	static constexpr std::uint64_t min_lot_size_min_value() noexcept
            	{ 
            		return 0; 
            	}
            	
            	static constexpr std::uint64_t min_lot_size_max_value() noexcept
            	{
            		return (UINT64_MAX - 1);
            	}
            	
            	static constexpr std::uint64_t min_lot_size_null_value() noexcept
            	{
            		return UINT64_MAX;
            	}
            
            	constexpr std::uint64_t min_lot_size() const noexcept
            	{ 
            		return min_lot_size_;
            	}
            	
            	constexpr auto& set_min_lot_size(std::uint64_t value) noexcept
            	{
            		min_lot_size_ = value;
            		return *this;
            	}
    ...
    class NoTradingSessions
    {
        ...
        class Entry
        {
            ...
            private:
            	std::uint16_t settl_date_{};
            
            public:
            	static constexpr std::size_t settl_date_size() noexcept
            	{
            		return sizeof(std::uint16_t);
            	}
            
            	static constexpr std::size_t settl_date_offset() noexcept
            	{ 
            		return 2; 
            	}
            
            	static constexpr std::size_t settl_date_id() noexcept
            	{ 
            		return 64; 
            	}
            	
            	static constexpr const char* settl_date_name() noexcept
            	{ 
            		return "SettlDate"; 
            	}
            	
            	static constexpr std::uint16_t settl_date_min_value() noexcept
            	{ 
            		return 0; 
            	}
            	
            	static constexpr std::uint16_t settl_date_max_value() noexcept
            	{
            		return (UINT16_MAX - 1);
            	}
            	
            	static constexpr std::uint16_t settl_date_null_value() noexcept
            	{
            		return UINT16_MAX;
            	}
            
            	constexpr std::uint16_t settl_date() const noexcept
            	{ 
            		return settl_date_;
            	}
            	
            	constexpr auto& set_settl_date(std::uint16_t value) noexcept
            	{
            		settl_date_ = value;
            		return *this;
            	}
            ...
            public:
            	...
            	// Safe: copy size bytes (capped at the field width) and NUL-pad the remainder.
            	auto &set_security_alt_id(const char *value, std::size_t size) noexcept
            	{
            		const auto length = size < security_alt_id_size() ? size : security_alt_id_size();
            		std::memcpy(security_alt_id_, value, length);
            		std::memset(security_alt_id_ + length, 0, security_alt_id_size() - length);
            		return *this;
            	}
            ...
            public:
            	...
            	constexpr std::uint8_t security_alt_id_source() const noexcept
            	{ 
            		return 4;
            	}
    ...
    public:
    	constexpr NoTradingSessions() = default;
    	NoTradingSessions(std::uint8_t count) noexcept
    		:header_(sizeof(NoTradingSessions::Entry), count) {}
    	...
    	template <class CharT, class Traits = std::char_traits<CharT>>
    	friend std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const NoTradingSessions &group)
    	{
    		os << "[";
    		for (auto i = 0; i < group.num_in_group(); i++)
    		{
    			...
    			os << "{";
    			bool comma = false;
    			if(comma) { os << ", "; } os << "\"TradeDate\": " << g.trade_date(); comma = true;
    			if(comma) { os << ", "; } os << "\"SettlDate\": " << g.settl_date(); comma = true;
    			if(comma) { os << ", "; } os << "\"MaturityDate\": " << g.maturity_date(); comma = true;
    			if(comma) { os << ", "; } os << "\"SecurityAltID\": " << "\"" << g.security_alt_id() << "\""; comma = true;
    			if(comma) { os << ", "; } os << "\"SecurityAltIDSource\": " << +g.security_alt_id_source(); comma = true;
    			os << "}";
    		}
    		os << "]";
    		return os;
    ...
    private:
    	NoTradingSessions no_trading_sessions_{};
    
    public:
    	static constexpr std::size_t no_trading_sessions_size() noexcept
    	{
    		return sizeof(typename NoTradingSessions::Entry);
    	}
    
    	static constexpr std::size_t no_trading_sessions_id() noexcept
    	{ 
    		return 386; 
    	}
    	
    	static constexpr const char* no_trading_sessions_name() noexcept
    	{ 
    		return "NoTradingSessions"; 
    	}
    
    	std::size_t no_trading_sessions_offset() const noexcept
    	{
    		return no_lot_type_rules_offset() + sizeof(NoLotTypeRules::header_) + no_lot_type_rules_data_length();
    	}
    
    	std::size_t no_trading_sessions_data_length() const noexcept
    	{
    		auto& group = no_trading_sessions();
    		return group.header_.block_length() * group.header_.num_in_group();
    	}
    	
    	const NoTradingSessions& no_trading_sessions() const noexcept
    	{ 
    		const auto* buf = buffer() + no_trading_sessions_offset();
    		return *reinterpret_cast<const NoTradingSessions*>(buf);
    	}
    	
    	NoTradingSessions& no_trading_sessions() noexcept
    	{
    		auto* buf = buffer() + no_trading_sessions_offset();
    		return *reinterpret_cast<NoTradingSessions*>(buf);
    	}
    
    	NoTradingSessions& AppendNoTradingSessions(std::uint16_t count) noexcept
    	{
    		auto* buf = buffer() + no_trading_sessions_offset();
    		auto& group = *reinterpret_cast<NoTradingSessions*>(buf);
    		group.header_.set_block_length(sizeof(typename NoTradingSessions::Entry));
    		group.header_.set_num_in_group(count);
    		return group;	
    	}
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFX63<N> &msg)
{
	os << "{";
	bool comma = false;
	...
	if(comma) { os << ", "; } os << "\"PriceQuoteCurrency\": " << "\"" << msg.price_quote_currency() << "\""; comma = true;
	...
	if(comma) { os << ", "; } os << "\"PricePrecision\": " << +msg.price_precision(); comma = true;
	...
	if(comma) { os << ", "; } os << "\"FXCurrencySymbol\": " << "\"" << msg.fx_currency_symbol() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"SettlType\": " << "\"" << msg.settl_type() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"InterveningDays\": " << msg.intervening_days(); comma = true;
	if(comma) { os << ", "; } os << "\"FXBenchmarkRateFix\": " << "\"" << msg.fx_benchmark_rate_fix() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"RateSource\": " << "\"" << msg.rate_source() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"FixRateLocalTime\": " << "\"" << msg.fix_rate_local_time() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"FixRateLocalTimeZone\": " << "\"" << msg.fix_rate_local_time_zone() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"MinQuoteLife\": " << msg.min_quote_life(); comma = true;
	if(comma) { os << ", "; } os << "\"MaxPriceDiscretionOffset\": " << msg.max_price_discretion_offset(); comma = true;
	...
	if(comma) { os << ", "; } os << "\"SettlementLocale\": " << "\"" << msg.settlement_locale() << "\""; comma = true;
	if(comma) { os << ", "; } os << "\"AltMinPriceIncrement\": " << msg.alt_min_price_increment(); comma = true;
	if(comma) { os << ", "; } os << "\"AltMinQuoteLife\": " << msg.alt_min_quote_life(); comma = true;
	if(comma) { os << ", "; } os << "\"AltPriceIncrementConstraint\": " << msg.alt_price_increment_constraint(); comma = true;
	if(comma) { os << ", "; } os << "\"MaxBidAskConstraint\": " << msg.max_bid_ask_constraint(); comma = true;
	...
	if(comma) { os << ", "; } os << "\"NoTradingSessions\": " << msg.no_trading_sessions(); comma = true;
	os << "}";
	return os;
}
}
