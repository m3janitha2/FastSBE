...
class Decimal9
{
    ...
    public:
    	...
    	constexpr Decimal9& set_mantissa(std::int64_t value) noexcept
    	{
    		mantissa_ = value;
    		return *this;
    	}
    ...
    public:
    	constexpr Decimal9() = default;
    
    	constexpr Decimal9(std::int64_t mantissa) noexcept
    		:mantissa_(mantissa)
    	{
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::Decimal9 &msg)
{
	os << "{";
	bool comma = false;
