...
class MDIncrementalRefreshVolumeLongQty66
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class MDIncrementalRefreshVolumeLongQty66;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshVolumeLongQty66<N> &msg)
{
	os << "{";
	bool comma = false;
