...
class MDIncrementalRefreshVolumeLongQty66
{
    ...
    public:
    	...
    	{ 
    		return "MDIncrementalRefreshVolumeLongQty66"; 
    	}
    ...
    class NoMDEntries
    {
    	friend MDIncrementalRefreshVolumeLongQty66;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshVolumeLongQty66::NoMDEntries &group)
{
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshVolumeLongQty66 &msg)
{
