...
class SnapshotFullRefresh52
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class SnapshotFullRefresh52;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::SnapshotFullRefresh52<N> &msg)
{
	os << "{";
	bool comma = false;
