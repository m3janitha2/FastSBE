...
class SnapshotFullRefreshTCP61
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class SnapshotFullRefreshTCP61;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::SnapshotFullRefreshTCP61<N> &msg)
{
	os << "{";
	bool comma = false;
