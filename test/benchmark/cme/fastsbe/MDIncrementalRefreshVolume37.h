...
class MDIncrementalRefreshVolume37
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class MDIncrementalRefreshVolume37;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshVolume37<N> &msg)
{
	os << "{";
	bool comma = false;
