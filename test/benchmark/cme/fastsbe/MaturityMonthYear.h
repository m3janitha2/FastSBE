...
class MaturityMonthYear
{
    ...
    public:
    	...
    	constexpr MaturityMonthYear& set_year(std::uint16_t value) noexcept
    	{
    		year_ = value;
    		return *this;
    	}
    ...
    public:
    	...
    	constexpr MaturityMonthYear& set_month(std::uint8_t value) noexcept
    	{
    		month_ = value;
    		return *this;
    	}
    ...
    public:
    	...
    	constexpr MaturityMonthYear& set_day(std::uint8_t value) noexcept
    	{
    		day_ = value;
    		return *this;
    	}
    ...
    public:
    	...
    	constexpr MaturityMonthYear& set_week(std::uint8_t value) noexcept
    	{
    		week_ = value;
    		return *this;
    	}
