...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDInstrumentDefinitionFuture54 &msg)
{
	...
	os << msg.decay_quantity_name() << ": " << msg.decay_quantity() << " ";
	os << msg.decay_start_date_name() << ": " << msg.decay_start_date() << " ";
	os << msg.original_contract_size_name() << ": " << msg.original_contract_size() << " ";
	os << msg.contract_multiplier_name() << ": " << msg.contract_multiplier() << " ";
	os << msg.contract_multiplier_unit_name() << ": " << msg.contract_multiplier_unit() << " ";
	os << msg.flow_schedule_type_name() << ": " << msg.flow_schedule_type() << " ";
