...
class Decimal9NULL
{
    ...
    public:
    	...
    	constexpr Decimal9NULL& set_mantissa(std::int64_t value) noexcept
    	{
    		mantissa_ = value;
    		return *this;
    	}
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::Decimal9NULL &msg)
{
