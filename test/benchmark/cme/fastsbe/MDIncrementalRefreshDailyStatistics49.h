...
class MDIncrementalRefreshDailyStatistics49
{
    ...
    class NoMDEntries
    {
    	friend MDIncrementalRefreshDailyStatistics49;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshDailyStatistics49::NoMDEntries &group)
{
