...
class MDIncrementalRefreshDailyStatistics49
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class MDIncrementalRefreshDailyStatistics49;
        ...
        class Entry
        {
            ...
            private:
            	MDEntryTypeDailyStatistics::Value md_entry_type_{};
            
            public:
            	static constexpr std::size_t md_entry_type_size() noexcept
            	{
            		return sizeof(MDEntryTypeDailyStatistics);
            	}
            	...
            	static constexpr MDEntryTypeDailyStatistics::Value md_entry_type_null_value() noexcept
            	{
            		return MDEntryTypeDailyStatistics::Value::nullValue;
            	}
            
            	constexpr MDEntryTypeDailyStatistics::Value md_entry_type() const noexcept
            	{ 
            		return md_entry_type_;
            	}
            	
            	constexpr auto& set_md_entry_type(MDEntryTypeDailyStatistics::Value value) noexcept
            	{
            ...
            private:
            	char block_trailing_padding_[7]{};
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshDailyStatistics49<N> &msg)
{
	os << "{";
	bool comma = false;
