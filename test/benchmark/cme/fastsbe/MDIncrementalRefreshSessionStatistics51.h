...
class MDIncrementalRefreshSessionStatistics51
{
    ...
    class NoMDEntries
    {
    	template <std::size_t> friend class MDIncrementalRefreshSessionStatistics51;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshSessionStatistics51<N> &msg)
{
	os << "{";
	bool comma = false;
