...
class MDIncrementalRefreshSessionStatistics51
{
    ...
    class NoMDEntries
    {
    	friend MDIncrementalRefreshSessionStatistics51;
...
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshSessionStatistics51::NoMDEntries &group)
{
...
template <class CharT, class Traits = std::char_traits<CharT>>
inline std::basic_ostream<CharT, Traits> &operator<<(std::basic_ostream<CharT, Traits> &os, const fastsbe::MDIncrementalRefreshSessionStatistics51 &msg)
{
